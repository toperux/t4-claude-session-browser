...
| T5 | P3 | tui | Marks are global across project/filter changes; `d` deletes off-screen sessions | medium | ✅(TUI) fix: keep global marks; confirm dialog shows "N of these are outside the current view" in **both** TUI and GUI |
